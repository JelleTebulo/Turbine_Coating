...
def plot_csv_data(file_path):
    ...
    # Create subplots
    fig3, axs3 = plt.subplots(2, 1, figsize=(8, 12))  # Two subplots arranged vertically
...
# Function to plot data from CSV
def plot_csv_data2(file_path1, file_path2):
    ...
    # Create subplots
    fig2, axs2 = plt.subplots(1, 1, figsize=(10, 6))  # Use the same size as your original code
...
# Plot data from both files
plot_csv_data2(file_path1, file_path2)
